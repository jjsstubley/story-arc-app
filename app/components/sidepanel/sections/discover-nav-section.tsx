...
import { Text, SimpleGrid, Heading, Avatar, Stack, Box } from "@chakra-ui/react"
...
export default function DiscoverNavSection({collections, genres, people}: {collections: { id: string, name: string }[], genres: GenreInterface[], people: PersonSummaryForInterface[]}) {
    const sections = [
        {
            title: "Collections",
            value: "collections",
