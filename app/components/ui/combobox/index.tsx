...
interface ComboboxProps extends BaseComboboxProps {
    onSelect: (item: ComboboxItemProp | null) => void;
    children?: (item: ComboboxItemProp) => ReactNode
}

export const CommandCombobox = ({ suggestions, onSelect, startElement = '/', placeholder = "Type to search", defaultOpen = true, children }: ComboboxProps) => {
