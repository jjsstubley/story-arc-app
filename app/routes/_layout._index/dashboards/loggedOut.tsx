...
export default function DashboardLoggedIn({ movieLists, trendingPeople, collections }: {movieLists: MovieListsInterface[], trendingPeople: TrendingPeopleInterface, collections: CollectionsInterface[]}) {
